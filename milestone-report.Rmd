---
title: "Coursera Capstone Project Milestone Report - 2025"
...
This is document is an assignment for the week 2 in the Data Science Capstone on Coursera.

This report aims to analyze the statistical characteristics of the dataset, which will later inform the development of a
predictive model for the final data product—the Shiny application. Through exploratory data analysis, it highlights key aspects of the
training dataset and outlines the approach for constructing the predictive model.

The model's training data comes from a consolidated document  that includes text from three primary sources: Blogs, News and Twittr
News
...
First, we will download, unzip and load the training data
